import sys
import os
from csv_scripts.get_unknown_inputs import get_unknown_inputs
...
def main():
    inputs, geometry_defects = get_unknown_inputs()

    interpolated_results = tims_SIF_interpolator.interpolate(inputs, geometry_defects)

    create_csv(inputs, interpolated_results, 'python_unknown_results.csv')
